...
public class Consultas extends AbstractEntity<Long>{
    ...
    public Profissionais getProfissional_id() {
        return profissional_id;
    }

    public void setProfissional_id(Profissionais profissional_id) {
        this.profissional_id = profissional_id;
    }

    public Pacientes getPaciente_id() {
        return paciente_id;
    }

    public void setPaciente_id(Pacientes paciente_id) {
